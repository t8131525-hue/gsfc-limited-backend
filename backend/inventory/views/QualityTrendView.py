...
from ..models import Version, ParameterDefinition, TestResult
...
class QualityTrendView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        for param in parameters:
            ...
            serializer = QualityTrendSerializer(param, context={'data_points': data_points})
            
            # Manually add the serialized data points to the response
            serialized_data = serializer.data
            serialized_data['data_points'] = QualityTrendDataPointSerializer(data_points, many=True).data
